...
class S {
  ...
  /// `WHO/FAO/UNU (2001)`
  String get calculationsTDEEWHO2001Label {
    return Intl.message(
      'WHO/FAO/UNU (2001)',
      name: 'calculationsTDEEWHO2001Label',
      desc: '',
      args: [],
    );
  }

  /// `Manual target (custom)`
  String get calculationsTDEEManualLabel {
    return Intl.message(
      'Manual target (custom)',
      name: 'calculationsTDEEManualLabel',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Custom targets`
  String get manualTargetsSectionLabel {
    return Intl.message(
      'Custom targets',
      name: 'manualTargetsSectionLabel',
      desc: '',
      args: [],
    );
  }

  /// `Set your own calorie and macronutrient goals.`
  String get manualTargetsDescription {
    return Intl.message(
      'Set your own calorie and macronutrient goals.',
      name: 'manualTargetsDescription',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Daily calories`
  String get manualCalorieGoalLabel {
    return Intl.message(
      'Daily calories',
      name: 'manualCalorieGoalLabel',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Carbs goal (g)`
  String get manualCarbsGoalLabel {
    return Intl.message(
      'Carbs goal (g)',
      name: 'manualCarbsGoalLabel',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Fat goal (g)`
  String get manualFatsGoalLabel {
    return Intl.message(
      'Fat goal (g)',
      name: 'manualFatsGoalLabel',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Protein goal (g)`
  String get manualProteinsGoalLabel {
    return Intl.message(
      'Protein goal (g)',
      name: 'manualProteinsGoalLabel',
      desc: '',
      args: [],
    );
  }

  /// `Please enter positive values for all targets.`
  String get manualTargetsValidationError {
    return Intl.message(
      'Please enter positive values for all targets.',
      name: 'manualTargetsValidationError',
      desc: '',
      args: [],
    );
  }
